...
x-data="{
   ...
   <div class="d-flex justify-content-between align-content-center my-2">
         ...
         <div class="dropdown ms-4" x-show="checked.length > 0" x-transition>
            ...
            <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
               <li><a href="#" class="dropdown-item" type="button"
                        onclick="confirm('Are you sure you want to delete these records?') || event.
                        stopImmediatePropagation()" @click="deleteMultipleRecords"
                    >
                     Delete
                  </a>
               </li>
      ...
      <div class="col-md-4">
         <input wire:model.debounce.500ms="search" type="search" class="form-control" placeholder="Search by name,email,phone,or address...">
      </div>
   </div>
      ...
      <table class="table table-hover">
         <tbody>
            ...
            <tr>
               ...
               <td>
                  <button class="btn btn-danger btn-sm" onclick="confirm('Are you sure you want to delete this record?') ||
                        event.stopImmediatePropagation()" @click="deleteSingleRecord({{ $student->id }})">
                     Delete
                  </button>
               </td>
            </tr>
